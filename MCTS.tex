...
No MMCTS a seleção é feita atravé do algoritmo chamado Exp3 (do Inglês Exponential-weight algorithm for Exploration and Exploitation) que foi proposto por \cite{auer1995gambling} para também resolver o problema dos caça-níqueis. O algoritmo está ilustrado em \ref{alg:exp3}. 

http://www.dklevine.com/archive/refs4462.pdf
https://hal.archives-ouvertes.fr/hal-00563480/file/auger.pdf
