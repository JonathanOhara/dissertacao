...
O MMCTS (do Inglês Multiple Monte Carlo Tree Search) foi proposto por \cite{DBLP:journals/corr/abs-1102-1580} para jogos com informações imperfeitas. Nesse algoritmo é criado uma árvore para cada jogador e essas árvore sáo buscadas simultaneamnete.
