...
Nos capítulos anteriores sobre árvore de jogos e aprendizagem de jogos com humanos. Nesse capítulo o foco será a implementação de um agente para o jogo Pokémon Showdown!. O interesse em fazer agente para esse jogo são quatro fatores. Alto nível de competidade, dezenas de milhares de pessoas jogam diaramente o jogo, além da existência de diversos campeonatos. Jogo de informações imperfeitas com grande nível de ramificação de escolhas. Jogo totalmente \textit{online}, podendo explorar o aprendizado com jogadores humanos num ambiente difícil de indentificar se o adversário é um \textit{bot} ou não. Possibilidade de criar uma API para possibilitar outros pesquisadores criar agentes e a possibilidad de se criar uma competição entre agentes jogadores.

O capítulo está organizado da seguinte forma: a primeira seção \ref{sec:pokemon} é apresentado a franquia de jogos Pokémon. Na próxima seção \ref{sec:batalhaspokemon} é apresentado as mecânicas e as regras das batalhas Pokémon. Na seção \ref{sec:apipokemonshowdown} será apresentado a API para se comunicar com o jogo Pokémonm Showdown!. Em \ref{sec:mctsPokemonShowdown} é mostrado alguns agentes utilizando MCTS para o Pokémon Showdown!.
...
Em 2016 a franquia completou 20 anos desde o lançamento de seu primeiro jogo. O último jogo da franquia principal foi lançado no final de 2016 chamado de Pokémon Sun e Pokémon Moon.

\subsection{Características de um Pokémon}

Nos jogos, um Pokémon é um monstro virtual semelhante a um animal ou objeto com super poderes. A caracterísitica final do Pokémon é baseado na característica de sua espécie e de suas características únicas. Essa combinação possiblita ter um grande nível de customização em cada Pokémon.

\subsubsection{Espécie}

A espécie é qual modelo aquele Pokémon representa. Existem atualmente mais de 800 espécies de Pokémon. Algumas espécies podem evoluir para outra espécie quando o Pokémon antige certos critérios. A figura \ref{fig:pokemonespecie} de \cite{pokedex} mostra quatro diferentes espécies Pokémon e suas principais características. Detalhadamente cada espécie Pokémon tem as seguintes características:
...
\begin{itemize}
	...
	\item \textbf{Estatísticas base}. As estatística ou atributos base são separado em 6 categorias:
...
A figura \ref{fig:pokemonmewto} de \cite{pokedex} mostra um exemplo de um espécie Pokémon e suas características.
...
Existme 18 tipos de Pokémon entre eles: planta, fogo, água, inseto, normal, venenoso, elétrico, terra, lutador, psíquico, pedra, voador, fantasma, gelo, dragão, metálico, noturno e fada.

Alguns tipos de Pokémons tem vantagem sobre outros tipos de Pokémons. A ideia é baseada no sistema papel pedra tesoura, onde o papel ganha de pedra, pedra ganha de tesoura e por sua vez tesoura ganha de papel. Porém no sistema de batalhas Pokémon essa mecânica é um pouco mais complexa uma vez que existem 2 tipos para cada Pokémon.
...
Para exemplificar esse cálculo de atributos mostrar como é importante a customização dentro do jogo do Pokémon, a seguir será calculado o atributo "Especial Ataque"  para 2 Pokémons da espécie Mewtwo ambos no nível 100. O Pokémon Mewtwo tem 154 pontos de Ataque Especial base.
...
As batalhas acontecem em maioria dos momentos do jogo, onde um treinador desafia um outro treinador, podendo o vencedor levar um pouco de dinheiro virtual ou uma medalha (também chamada de insígnea).

Cada treinador pode utilizar até 6 pokémons sem quaisquer restrições. Vence o treinador que desmaiar todos os Pokémon do adversário primeiro, ou seja, quando todos os Pokémon de um treinador estiverem com o HP igual a zero.

A batalha é realizada por turnos simultâneos. Ao começar a batalha ambos jogadores colocam um Pokémon no campo de batalha, chamado de Pokémon ativo. Para ambos os jogadores é mostrado as opções de golpes e as opções para trocar de Pokémon.
...
\begin{itemize}
	...
	\item \textbf{2}. Golpes de prioridade positiva. Existe um pequeno conjunto de golpes que faz o Pokémon atacar primeiro idependente do critério 3. Se ambos o Pokémon utilizarem golpes de prioridade o critério 3 decidirá quem realiza a ação primeiro.
	
	\item \textbf{3}. O Pokémon com maior atributo de velocidade ataca primeiro.
	
	\item \textbf{4}. Golpes de prioridade negativa. Existe também um pequeno conjunto de golpes que faz o Pokémon atacar por último idependente do critério 3. Se ambos o Pokémon utilizarem golpes de prioridade negativa o critério 3 decidirá quem realiza a ação primeiro.
	
\end{itemize}

\subsection{Golpes do Pokémon}

Uma das customizações mais importantes é quais golpes o Pokémon irá poder utilizar. Cada Pokémon pode escolher 4 golpes entre dezenas de golpes disponíveis para sua espécie. Cada espécie de Pokémon pode aprender um conjunto diferente de habilidades dependendo do seu tipo e características (por exemplo, apenas Pokémons com chifre conseguem aprender o golpe \textit{Mega Horn}). Existem mais de 600 golpes diferentes.
...
No golpe que o sistema papel, pedra e tesoura é aplicado. Existem 6 Situações que podem acontecer quando o golpe é utilizado em um Pokémon:
...
\begin{itemize}
	...
	\item \textbf{PAR} Estado paralisado, nesse estado o Pokémon tem 25\% de chance de errar seu golpe e, sua Velocidade é reduzido para 25\% do valor.
...
Como existem Pokémon com atribuitos muitos mais altos e com movimentos muito melhores que outros algumas regras foram definidas para tornar as batlhas mais justas.

O Pokémon Showdown! segue as regras definida por uma comunidade de jogadores competitivos chamada Smogon \cite{smogon}, essa comunidade regula e define as regras que são utilizadas em cada modo de jogo, para que o jogo se torne mais competitivo e balanceado. Um dos principais trabalhos da Smogon é balancear os mais de 800 Pokémons distribuindo eles em faixas chamadas de \textit{tiers}. Do mais fraco para o mais fortes os principais \textit{tiers} são:
...
O jogo Pokémon Showdown! tem algumas dezenas de modos de batlhas diferentes como mostra a imagem
...
\begin{itemize}
	...
	\item \textbf{Random battle} os dois jogadores são pareados com times totalmente aleatórios. Para balancear esse modo é atribuído diferentes níveis de acordo com o \textit{tier} do Pokémon. Pokémon NU batalham no nível 86, RU 82, UU 78, OU 74 e \textit{Ubers} no 70.
	...
	\item \textbf{Battle Factory} nesse modo primeiro é sorteado um \textit{tier}, cada jogador recebe um time equilibrados predefinidos desse \textit{tier}. Nesse modo todos Pokémon batalham no mesmo nível.Por ser o modo de batalha onde os times dependem menos da sorte é o preferido entre os jogadores profissionais.
...
\caption[Modos de batlaha Pokémon Showdown!]{Modos de batlaha Pokémon Showdown!.}
