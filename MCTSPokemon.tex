...
Em adição da API de \textit{gameplay} foi desenvolvido uma API para simular situações e, ações em deterimanado cenários. Isso pode ser feito, pois o código fonte do Pokémon Showdown! (servidor e cliente) é aberto.
...
\begin{itemize}
	...
	\item \textbf{chooseSwitch}. Esse método recebe como argumento um inteiro com valor de 1 a 6 relacionado para qual Pokémon será efetuado a troca.
