...
O primeiro agente que será testado contra jogadores humanos é o agente 3 (grafo). Várias versões do agente serão criadas, cada versão será calibrada com uma profundidade diferente em sua árvore. Cada versão do agente será submetido a uma série de batalhas que terminará quando seu ranqueamento no jogo se estabilizar.
