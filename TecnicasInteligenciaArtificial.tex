...
Outro problema do \textit{minimax} é a quantidade de nós que ele precisa analisar, em jogos com grande número de possíveis jogadas ou que duram um grande número de turnos (grande profundidade na árvore) a quantidade de nós que ele precisa analisar é muito grande. 
