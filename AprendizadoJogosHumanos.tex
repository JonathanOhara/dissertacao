...
Cada rede neural é subdividia em lóbulos que definem as características elétricas, químicas e morfológicas de um grupo de células. Ao todo cada rede neural tem aproximadamente 1000 neurônios agrupados em 9 lóbulos e interconectados por 5000 sinapses. A imagem de \ref{fig:creatureNeuros} de \cite{grand1997creatures} mostra como está disposto esses elementos.

\begin{figure}[H]
\centering
\includegraphics[width=10cm]{figures/CreaturesNeurons.png}
\caption[Rede neural Creatures]{Rede neural Creatures.}
\label{fig:creatureNeuros}
\end{figure}
