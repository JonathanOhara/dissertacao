...
Emboras as diferentes definições, muitas coisas são comuns ou muito parecidas como a presença de  características como autonomia, aprendizado, objetivos e comunicabilidade. 
...
Na figura \ref{fig:angrybirdsai} pode ser visto como a API se comunica com jogo. Uma imagem é caputrada do navegador e a partir disso é utilizado um algoritmo de reconhecimento de imagem para identificar o que é cada objeto (os quadrados em volta do objeto é o que a API está reconhecendo).
